...
public class SpatialJoin implements FlexibleJoin<OGCGeometry, SpatialJoinConfiguration> {
    public int n;
    ...
    public SpatialJoinConfiguration divide(Summary<OGCGeometry> s1, Summary<OGCGeometry> s2) {
        //intersection
        ...
        return new SpatialJoinConfiguration(c1.MBR, this.n);
    }

    public int[] assign1(OGCGeometry k1, SpatialJoinConfiguration SpatialJoinConfiguration) {
